...
public class CachingBigQueryClient
{
    private static final Object NULL_MARKER = new Object();

    private final BigQueryClient delegate;
    ...
    @Inject
    public CachingBigQueryClient(
            @StatsCollecting BigQueryClient delegate,
